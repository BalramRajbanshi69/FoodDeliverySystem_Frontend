...
import DigitalLogo from "../../../assets/DigitalLogo.jpg"
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div className="group">
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-lg flex items-center justify-center transition-transform duration-500 group-hover:rotate-12">
            ...
            <p className="text-gray-300 mb-6">Revolutionizing dining by enabling seamless online food ordering with a single click.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'Foods', 'Services', 'Blog'].map((link) => (
                <li key={link}>
                  <a
                    href="#"
          ...
          <div>
            ...
            <form className="mt-4">
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-4 py-1 transition"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; <span className="text-blue-400">{currentYear} DigitalKhana.</span> All rights reserved.
          </p>
      ...
      <div className="orb absolute w-64 h-64 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 blur-3xl pointer-events-none opacity-30 transition-transform duration-100 ease-out"></div>
    </footer>
  );
};
