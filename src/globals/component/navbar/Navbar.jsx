            ...
            <div className="flex flex-wrap items-center justify-between py-3 gap-6 md:py-4 md:gap-0">
                <div className="w-full px-6 flex justify-between lg:w-max md:px-0">
                    <Link to="/"  aria-label="logo" className="flex space-x-2 items-center">
                        <span className="text-2xl font-bold text-yellow-900">Digital<span className="text-yellow-700"> Food</span></span>
                    </Link>
...
<span>Wishlist</span>
                            ...
                            <li>
                                <Link to="/cart"   className="block md:px-4 transition hover:text-yellow-700">
